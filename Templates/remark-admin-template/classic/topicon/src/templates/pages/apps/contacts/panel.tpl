<header class="slidePanel-header overlay" style="background-image: url('{{global}}/photos/placeholder.png');')">
  <div class="overlay-panel overlay-background vertical-align">
    <div class="slidePanel-actions">
      <div class="btn-group">
        <button type="button" class="btn btn-pure icon wb-folder" aria-hidden="true"></button>
        <button type="button" class="btn btn-pure icon wb-trash" aria-hidden="true"></button>
